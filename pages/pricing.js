...
function Pricing({}) {
   ...
   // meta description
   const pageTitle = 'KW | Contact Us';
   const pageDescription = 'KW | Contact Us';
   ...
   const onSubmit = (data) => {
      if (agreed) {
         axios
            .post(process.env.NEXT_PUBLIC_PROD_URL + '/api/contact/new', {
               email: data.email,
         ...
         <div className="bg-white py-16 px-4 overflow-hidden sm:px-6 lg:px-8 lg:py-24">
            <div className="relative max-w-7xl mx-auto">
               ...
               <div className="text-center">
                  <span className="text-4xl font-bold my-4"> Pricing</span>
                  <p className="mt-4 text-lg leading-6 max-w-2xl mx-auto  text-gray-500">
                     We've got a pricing plan that's perfect for you, we beleive that keyword
                     research tools should be accessible to all companies and individuals who want
                     to find keywords with low SEO difficulty.
                  </p>
               </div>
                     ...
                     <div className="grid grid-cols-3 mt-10">
                        ...
                        <div className=" ">
                           ...
                           <p className="md:text-base text-xs text-[#7e7e7e]">
                              <span className="font-semibold md:text-4xl text-xl text-black">
                                 $0
                              </span>{' '}
                              per month
                           </p>
                  ...
                  <div className="flex flex-col">
                     ...
                     <div className="grid grid-cols-3 my-2 rounded-md bg-[#F9FAFC] px-3  py-2">
                        <div className="flex md:text-base text-sm  items-center font-semibold">
                           ...
                           <Tooltip
                              ...
                              title="Analyzing your competitors is easy with our Competitor Research tool. Start studying your rivals">
                              <IconButton>
                                 <BsQuestionCircle className=" w-4 h-4" />
                              </IconButton>
                           </Tooltip>
                     ...
                     <div className="grid grid-cols-3 my-2 rounded-md  px-3  py-2">
                        <div className="flex md:text-base text-sm  items-center font-semibold">
                           ...
                           <Tooltip
                              className="flex justify-center "
                              title="Our algorithms will provide with a difficulty score for each keyword.">
                              <IconButton>
                                 <BsQuestionCircle className=" w-4 h-4" />
                              </IconButton>
                           </Tooltip>
                     ...
                     <div className="grid grid-cols-3 my-2 rounded-md  px-3  py-2">
                        <div className="flex md:text-base text-sm  items-center font-semibold">
                           ...
                           <Tooltip
                              className="flex justify-center "
                              title="Number of keywords returned by your platform.">
                              <IconButton>
                                 <BsQuestionCircle className=" w-4 h-4" />
                              </IconButton>
                           </Tooltip>
